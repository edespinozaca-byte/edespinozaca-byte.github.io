...
<head>
  ...
  <title>Flores Amarillas para Mi Cachetona</title>
  <style>
    body {
      margin: 0;
      padding: 0;
    ...
    .flower::after { transform: rotate(-60deg); }
    ...
    .close-btn:hover { background: orange; }
...
<body>
  ...
  <div class="bouquet">
    ...
    <div class="stem"></div>
    <div class="ribbon">"Mi Cachetona 💛"</div>
  ...
  <div id="myModal" class="modal">
    <div class="modal-content">
      ...
      <span class="heart" style="top:10%; left:20%;">❤️</span>
      <span class="heart" style="top:50%; left:80%;">❤️</span>
      <span class="heart" style="top:70%; left:40%;">❤️</span>
    </div>
  </div>
